...
final class _$JellyfinOpenapiStable extends JellyfinOpenapiStable {
  _$JellyfinOpenapiStable([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final Type definitionType = JellyfinOpenapiStable;
